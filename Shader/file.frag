...
void main() {
    ...
    if (vertexWorldPos.y > 300.f) {
        ...
        addVal /= 1.5f;
    } else if (vertexWorldPos.y > 80.f) { // mountain brown
        color = vec4(80.f/255.f,40.f/255.f,10.f/255.f,1.f);
    } else if (vertexWorldPos.y > 75.f) { // red sandstone
        color = vec4(130.f/255.f,16.f/255.f,20.f/255.f,1.f);
    } else if (vertexWorldPos.y > 20.f) { // grass
        color = vec4(70.f/255.f,240.f/255.f,20.f/255.f,1.f);
    } else if (vertexWorldPos.y > 5.f) { // sand
    ...
    vec3 light = max(vec3(0), dot(normalize(fragNormal), normalize(sun))) / vec3(5.f) + addVal;
